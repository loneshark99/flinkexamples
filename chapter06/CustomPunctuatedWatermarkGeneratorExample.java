...
public class CustomPunctuatedWatermarkGeneratorExample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        env.socketTextStream("localhost", 4567)
                ...
                .assignTimestampsAndWatermarks(WatermarkStrategy.<CityTemperature>forGenerator(context -> new PunctuatedWatermarkGenerator())
    ...
    private static class PunctuatedWatermarkGenerator implements WatermarkGenerator<CityTemperature> {

        @Override
        public void onEvent(CityTemperature event, long eventTimestamp, WatermarkOutput output) {
