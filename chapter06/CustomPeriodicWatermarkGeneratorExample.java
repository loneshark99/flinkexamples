...
public class CustomPeriodicWatermarkGeneratorExample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        env.socketTextStream("localhost", 4567)
                ...
                .assignTimestampsAndWatermarks(WatermarkStrategy.<CityTemperature>forGenerator(context -> new PeriodicWatermarkGenerator<>())
    ...
    private static class PeriodicWatermarkGenerator<T> implements WatermarkGenerator<T> {
