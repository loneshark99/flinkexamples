...
public class HdfsFileSystemSinkConnectorAvro {
    ...
    public static void main(String[] args) throws Exception {
        ...
        FileSink<GenericRecord> fileSink = FileSink.<GenericRecord>forBulkFormat(new Path("hdfs://hadoop151:8020/test"),
                        AvroWriters.forGenericRecord(AVRO_SCHEMA))
                .withRollingPolicy(
                        OnCheckpointRollingPolicy.build()
                )
                .withBucketAssigner(new DateTimeBucketAssigner<>("yyyy-MM-dd-HH"))
                .withOutputFileConfig(new OutputFileConfig("alex", ".avro"))
                .build();
